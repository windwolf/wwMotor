...
void MX_TIM2_Init(void)
{
  ...
  HAL_TIMEx_RemapConfig(&htim2, TIM_TIM2_ETR_LSE);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ENW_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM1;
    HAL_GPIO_Init(ENW_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOB, EN_FAULT_Pin|ENU_Pin|ENV_Pin|ENW_Pin);

    HAL_GPIO_DeInit(GPIOA, INU_Pin|INV_Pin|INW_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(H1_GPIO_Port, H1_Pin);

    HAL_GPIO_DeInit(H2_GPIO_Port, H2_Pin);
