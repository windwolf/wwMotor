...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB11     ------> ADC2_IN14
    */
    GPIO_InitStruct.Pin = CURR1_Pin|CURR3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    GPIO_InitStruct.Pin = CURR2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CURR2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOC, BEMF1_Pin|BEMF3_Pin|BEMF2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB11     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOA, CURR1_Pin|CURR3_Pin);

    HAL_GPIO_DeInit(NTC_GPIO_Port, NTC_Pin);

    HAL_GPIO_DeInit(CURR2_GPIO_Port, CURR2_Pin);
