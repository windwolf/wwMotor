 ...
 * @param d_sample
 */
void SvpwmModular::module(Motor& motor, uint8_t& section, Vector3f& d_abc, Vector3f& u_abc,
    ...
    // Vector2f u_ab;
    // FocMath::dq2ab(motor.reference.u_dq, motor.state.position.v1, u_ab);
...
Result SvpwmModular::apply_config() {
