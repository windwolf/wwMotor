...
namespace wibot::motor
{
	...
	Result FocControl::apply_config()
	{
		...
		_phaseCurrentSensor.config.low_duty_skip_threshold = config.current_sensor.low_duty_skip_threshold;
		...
		_positionSpeedSensor.config.mech_pos_cutoff_freq = config.motor_parameter->speed_limit / 60 * 1.2;
		_positionSpeedSensor.config.mech_speed_cutoff_freq = config.motor_parameter->speed_limit / 60 * 1.2;
		...
		_currentController.config.bandWidth = config.current_controller.bw;
