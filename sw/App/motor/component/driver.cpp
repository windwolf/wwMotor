...
void DriverSVPWM::config_update(Config &config)
{
    this->config = config;
    sqDModuleLimit = config.maxDModuleRate * config.maxDModuleRate / 3;
    sqModuleLimit = config.maxModuleRate * config.maxModuleRate / 3;
    // TODO: update only vbus changed.
    dModuleLimit = _1_SQRT3 * config.maxDModuleRate;
};
